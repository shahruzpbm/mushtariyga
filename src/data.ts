...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Menda bir shior bor: qayg'u eshik qoqsa — kulib yuboring! Tabassum — dunyodagi eng arzon va eng kuchli sehr.",
  ...
  },
  {
    ...
    lines: [
      "Hey, Mushtariy.",
      "Men har kimga tabrik yozib yuradigan odam emasman... Lekin sen — boshqachasan. Tug'ilgan kuning muborak.",
      "Bugun qo'shiq o'rniga faqat sening kulging yangrasin. Xo'sh, bu oramizda qoladigan sir: sen uchun bir qo'shiq belgilab qo'ydim. Qachon eshitgining kelsa — murojaat qil, eshittiraman.",
